...
void SP_handleConnect() {
  ...
  strcpy(portalCfg.host, _SP_server.arg("Host").c_str());
  strcpy(portalCfg.port, _SP_server.arg("Port").c_str());
  strcpy(portalCfg.login, _SP_server.arg("Login").c_str());
  strcpy(portalCfg.pass_mqtt, _SP_server.arg("Pass").c_str());
